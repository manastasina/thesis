...
\subsection{Influenza A virus organization and replication cycle}
	...
	Influenza A virions are pleiomorphic, i.e. their shapes are not uniform and can be spherical, kidney- or rod-shaped with the average size of 100--150 nm \parencite{Fujiyoshi1994}. The outer shell of the virions is composed of the host-derived lipid bilayer in which viral \gls{HA}, \gls{NA} and \gls{M2} are incorporated. This shell is underlined with the viral \gls{M1} \parencite{Harris2006}. Each virion encompasses genomic RNA segments packed in specific structures referred to as \gls{vRNP}. They represent supercoiled ring-like structures in which paired 5' and 3' ends of the viral RNA are associated heterotrimetic viral polymerase complex and the rest of the RNA is densely covered with \gls{NP} \parencite{Arranz2012}. Eight genes of all influenza A viruses encode 10 essential viral proteins: \gls{HA}, \gls{NA}, \gls{M1}, \gls{M2}, \gls{NP}, \gls{PB1}, \gls{PB2}, \gls{PA}, \gls{NS1}, and \gls{NEP} \parencite{Lamb1983}. In addition, some influenza A strains may encode accessory proteins PB1-F2, PB1-N40, PA-X, PA-155 and PA-182. Whereas \gls{HA}, \gls{NA}, \gls{M1}, \gls{M2}, \gls{NP}, \gls{PB1}, \gls{PB2}, \gls{PA} and \gls{NEP} are structural components of viral particle, \gls{NS1}, PB1-F2, PB1-N40, PA-X, PA-155 and PA-182 are considered to be non-structural and are involved in regulation of virus-host interactions \parencite{Chen2001,Hale2008b,Wise2009,Jagger2012,Muramoto2013}.
	
	The viral replication cycle begins when viral \gls{HA} binds to the viral receptor on cell surface. The receptor is a sialic acid; they can be alpha-2,3- or alpha-2,6-linked and this to a large extent defines the host range. Avian viruses bind to 2,3-linked sialic acids and mammalian bind to 2,6-linked sialic acids. Upon binding to its receptor the virion is internalized in the cell via endocytic route. The virion only uncoats in the endosome and this requires phusion of viral and endosomal membranes at acidic pH generated by the cellular vacuolar ATPase and M2 in the viral outer layer. Unlike most of the RNA viruses, influenza A virus replication takes place in the nucleus. After uncoating the vRNPs are imported in the nucleus through ... probably via the NLS on the proteins, constituting the vRNP. Which exactly is responsible is hard to say, because both NP, and all polymerase subunits have their own NLS.
	
	In the nucleus the vRNPs are transcribed by the viral polymerase adjacent to the partially base-paired termini of \gls{vRNA} \parencite{Moeller2012}. Synthesis of viral mRNA is initiated using a 10--13 nucleotide long primers with \gls{5meG} \parencite{Beaton1981, Plotch1981a}. These primers are derived via a process of cap-snatching, during which the \gls{5meG} cap structures on cellular mRNAs are recognized and bound by \gls{PB2} subunit of viral polymerase \parencite{Guilligay2008} and further endonucleolytically cleaved by viral \gls{PB1} and \gls{PA} \parencite{Li2001, Dias2009, Yuan2009}. The resulting primers provide 3'-OH ends enabling mRNA chain elongation by \gls{PB1} \parencite{Poch1989}.
	
	The viral messengers are almost indistinguishable from the celluar mRNAs: they have a 3' poly(A) generated from repeated copying of polyuridine tracts on the 5' end of vRNA and a 5' cap, that is ``snatched'' from the cellular transcripts by PA or PA-X.
	
	The replication of viral genomes occurs through production of \gls{cRNP}, consisting of complimentary viral RNA, polymerase complex and NP, which afterwards serves as a template for synthesis of new \gls{vRNP}s. Unlike mRNA synthesis, the cRNA and new vRNAs are produced by a second polymerase complex and in this This  and (+)cRNA, which is then used as a template for produciton of viral genomic (-)RNAs. In is considered, that the viral RNA densly packed in vRNPs is partially unpacked during its transcription and replication. 
	
	 The functional viral transcripts are then exported from the nucleus and undergo translation in the cell cytoplasm. Depending on the presence of corresponding localization signals, viral proteins stay in the cytoplasm of shuttle between the cytoplasm and the nucleus. The assemble of vRNPs from newly syntehsized vRNA, NP and viral polymerase complex occurs in the nucleus, from where the vRNPs are then exported using the export signals on ... The export of vRNPs is facilitated by NEP. The vRNPs and other viral proteins are then transported through the Golgi network and the assembly of the virion occurs at the cellular outer membrane at lipid rafts. The HA, NA and M2 are embedded in the cellular membrane, the membrane curvature is initiated by ..., the M1 forms the underlying matrix and the vRNPs are packed in the virion. The number of vRNPs can be... and is regulated by ... (or unknown). The budding is regulated by ... . The NA in the virion cleave SAs and the virion can pinch off the cell. The virion maturation occurs when ... after which functional virions can initiate a new infection cycle.
